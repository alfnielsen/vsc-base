...
<>
      ...
      <AppendToActiveDocumentAnnotatedCode />
      ...
      <FindRelativeFilePathsAnnotatedCode />
      <GetAbsolutePathFromRelatrivePathAnnotatedCode />
      <GetActiveDocumentAnnotatedCode />
      <GetActiveDocumentContentAnnotatedCode />
      <GetActiveDocumentPathAnnotatedCode />
      <GetActiveEditorAnnotatedCode />
      <GetConfigAnnotatedCode />
      <GetDirAnnotatedCode />
      <GetErrorInfoAnnotatedCode />
      <GetFileContentAnnotatedCode />
      <GetFullDocumentRangeAnnotatedCode />
      <GetJSONCircularReplacerAnnotatedCode />
      <GetJsonContentAnnotatedCode />
      <GetJsonPartsAnnotatedCode />
      <GetLineStreamReaderAnnotatedCode />
      <GetPackageDependenciesAnnotatedCode />
      <GetPackageFilePathsAnnotatedCode />
      <GetReadStreamAnnotatedCode />
      ...
      <ScaffoldTemplateAnnotatedCode />
      <SetActiveDocumentContentAnnotatedCode />
      <SharedPathAnnotatedCode />
