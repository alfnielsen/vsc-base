...
suite('Vsc base Tests', function() {
   ...
   suite('absolutePathToSubRalative', () => {
      test(' 1', () => {
         const r1 = vsc.absolutePathToSubRalative('c:/root/modules/file1.js', 'modules/file2.js', 'c:/root/')
         assert.equal(r1, './file2.js')
      })
   })
   suite('relatrivePathToAbsolutePath', () => {
      test(' 1', () => {
         const r1 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.js', '../file2', 'c:/root/')
         assert.equal(r1, 'file2')
      })
      test(' 2', () => {
         const r2 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.ts', './file2', 'c:/root/')
         assert.equal(r2, 'modules/file2')
      })
      test(' 3', () => {
         const r3 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.tsx', './sub/file2', 'c:/root/')
         assert.equal(r3, 'modules/sub/file2')
      })
      test(' 4', () => {
         const r4 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.jsx', 'modules/file3', 'c:/root/')
         assert.equal(r4, 'modules/file3')
      })

      test(' 5', () => {
         const r5 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.jsx', 'react', 'c:/root/')
         assert.equal(r5, 'react') // besuce it looks like an absolute path!
      })
      test(' 6', () => {
         const r6 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.js', '../modules/file2', 'c:/root/')
         assert.equal(r6, 'modules/file2')
      })
      test(' 7', () => {
         const r7 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.js', '../modules2/file4', 'c:/root/')
         assert.equal(r7, 'modules2/file4')
      })
      test(' 8', () => {
         const r8 = vsc.relatrivePathToAbsolutePath('c:/root/modules/file1.js', '../file2', 'c:/root')
         assert.equal(r8, 'file2')
      })
      test(' 9', () => {
         const r9 = vsc.relatrivePathToAbsolutePath('c:/root/modules/sub/sub2/file1.js', '../../file2', 'c:/root')
