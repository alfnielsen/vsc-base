 ...
 */
export declare const tsCreateProgram: (code: string, sourceFileName?: string, compilerOptions?: Readonly<ts.CompilerOptions>, compilerHost?: ts.CompilerHost) => (ts.SourceFile | ts.Program | undefined)[];
/** vsc-base method
 * @description
